...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Handle login button click in the modal (you can add functionality to these buttons)
    var loginModalLoginButton = document.getElementById('login-modal-login');
    var loginModalRegisterButton = document.getElementById('login-modal-register');
    ...
    loginModalRegisterButton.addEventListener('click', function () {
